...
const LinkForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const {data:genaratedLink} = await axios.post('http://localhost:5000/link/generate',formData);
      console.log(genaratedLink);
      // 
      message.success('Link generated successfully!');
      console.log('Generated Link:', genaratedLink?.shareableLink);
    } catch (error) {
